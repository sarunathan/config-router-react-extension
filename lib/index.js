...
var GlobalProvider = (0, _reactRedux.createProvider)("global");
...
var createInstance = function createInstance(moduleData) {
    ...
    var renderGlobalProvider = _react2.default.createElement(GlobalProvider, { store: settings.dataStore }, renderModule);

    var renderLocalProvider = _react2.default.createElement(_reactRedux.Provider, { store: moduleData.instanceStore }, renderGlobalProvider);
