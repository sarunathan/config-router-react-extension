...
var createInstance = function createInstance(moduleData) {
    return Promise.resolve(_reactDom2.default.render(_react2.default.createElement(_reactRedux.Provider, { store: settings.dataStore }, _react2.default.createElement(moduleData.module, {
...
var destroyInstance = function destroyInstance(moduleData) {
    _reactDom2.default.unmountComponentAtNode(document.querySelector(moduleData.instanceConfig.container));
};
